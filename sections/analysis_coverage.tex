...
\input{figures/analysis_coverage_float}

\textbf{Higher coverage in shorter reports.}\quad
The refined map reaches 88.1--98.2\% task-requirement coverage and 71.3--88.4\%
failure-mechanism coverage, while using 12--29\% fewer words
(Figure~\ref{fig:analysiscoverage}). It exceeds both the paired and original
grades of the unchanged coding-agent reports on all three corpora; the ordering
