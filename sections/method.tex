...
analysis refinement. Section~\ref{sec:experiments} and
Appendix~\ref{app:versions} distinguish these from the earlier protocols
underlying the reported training curves.

\input{figures/framework_float}
...
original trajectories. Task-linked measurement and construction details are
given in Appendix~\ref{app:analysisconstruction}. This coverage-checked variant
...
Construction and acceptance details appear in
Appendix~\ref{app:constructionrefinement}.
