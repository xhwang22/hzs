...
\begin{table}[ht]
\centering\small
\input{tables/analysis_families}
...
Figure~\ref{fig:evidencegaps} reads the final native strict-coverage grades
directly from the same frozen results as Figure~\ref{fig:analysiscoverage}.
